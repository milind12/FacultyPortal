<%-- 
    Document   : paper_article
    Created on : May 14, 2016, 2:38:47 PM
    Author     : Milind Ghiya
--%>
...
<style> 
    ...
    background-color: transparent ;box-shadow: 5px 5px 5px #888888;border:2px solid magenta;}
...
<body>
   ...
   <c:set var="retpath" value="paper_article.jsp" scope="session"/>
    ...
    <form method="post" action="UploadServlet"
          enctype="multipart/form-data"><center>
            <center> 
            <font color="indianred"><h2>Hello, 
        <c:if test="${sessionScope.user!= null}">${sessionScope.user.userName}</c:if></h2></font></center>
   
        <table >
             <th align="left"><strong style="font-size:23px">Articles :</strong>
             </th>
            <tr>
                <td >
...
<ul ><d:printlist pagename="paper_article.jsp" /></ul>
</div>
