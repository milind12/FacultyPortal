<%-- 
    ...
    Created on : May 14, 2016, 2:37:49 PM
    Author     : Milind Ghiya
--%>
...
<head>
    ...
    background-color: transparent ;box-shadow: 5px 5px 5px #888888;border:2px solid blue;}
...
<body>
    <%@include file="header.html"%>
     <c:set var="retpath" value="certificate.jsp" scope="session" />
    <c:choose>
    ...
    <div class="container" style="height:300px;padding-left: 30px;margin-left: 280px;padding-left: 130px;padding-top: 40px;margin-top: 80px">
       ...
       <h2>Hello, 
        <c:if test="${sessionScope.user!= null}">${sessionScope.user.userName}</c:if></h2></font></center>
               ...
               <form method="post" action="UploadServlet" enctype="multipart/form-data">
                 ...
                 <table >
                     <th align="left"><strong   style="font-size:23px">Any Other:</strong>
                         </th>
                       <tr>
           
                      <td >
                    
                     <font style="color:indianred">*</font>Select file to upload:</td>
                <td><input type="file" name="file" size="60" style="background-color:deepskyblue;color:white" required/></td>
            </tr>
                                <tr>
                 <td ><font style="color:indianred">*</font>Name of document:</td>
                 <td><input type="text" name="docname" placeholder="Enter document name" size="29" required/></td></tr>
             ...
             <tr><td align="center">
              ...
              <ul>
              <d:printlist pagename="certificate.jsp" />
              </ul>
      </div> -->
                             </div>
